...
[This is an invalid link: ./foobar](/foobar)
[valid: flow-fees](flow-fees)
[valid: flow-fees.mdx](flow-fees.mdx)
[valid: ./flow-fees](./flow-fees)
[valid: ./flow-fees.mdx](./flow-fees.mdx)
[invalid: flow-fees.md](flow-fees.md)
[invalid: flow-fees.](flow-fees.)
